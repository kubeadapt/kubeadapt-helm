...
The scope of the change must be included in the title. The scope should be the name of the component you are changing. For example, if you are changing the `kubeadapt-agent`, the title of your pull request should be `fix(kubeadapt-agent): Fix typo in deployment.yaml`.

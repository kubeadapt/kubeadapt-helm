...
| https://prometheus-community.github.io/helm-charts | prometheus | 27.51.0 |
...
| prometheus.serverFiles."prometheus.yml".scrape_configs[4].metric_relabel_configs[0].regex | string | `"^(kubeadapt_agent_build_info|kubeadapt_agent_collection_duration_seconds.*|kubeadapt_agent_collection_total|kubeadapt_agent_data_points_total|kubeadapt_agent_prometheus_query_duration_seconds.*|kubeadapt_agent_prometheus_queries_total|kubeadapt_agent_backend_post_duration_seconds.*|kubeadapt_agent_last_collection_duration_seconds|kubeadapt_agent_last_backend_post_duration_seconds|kubeadapt_agent_compression_ratio|kubeadapt_agent_compression_duration_seconds.*)$"` |  |
